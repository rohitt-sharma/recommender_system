...
@app.post("/recommender_sys/")

def recommendation_sys(item: recommender):

    movie_name = str(item.movie_watched)
    ...
    def get_recommendations(title, cosine_sim=cosine_sim2):
        ...
        movie_list.append(df2['title'].iloc[movie_indices])
        print(df2['title'].iloc[movie_indices])
